...
<head>
    ...
    <title>Registro Cliente Jurídico</title>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="form-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Correo Empresarial 2*" value="" />
                            </div>
                            <div class="form-group">
        ...
        <!--------------------------------------------------------fiN fORMULARIO Cuarto------------------------------------------------------->

        <!-------------------------------------------------------------------Quinto Formulario -------------------------------------->
        <div class="container register-form">
            <div class="form">
                <div class="note">
                    <h3>CLASIFICACION TIPO CLIENTE <h3>
                </div>
